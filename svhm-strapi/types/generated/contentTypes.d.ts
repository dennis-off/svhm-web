...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    author: Schema.Attribute.Relation<'oneToOne', 'api::member.member'>;
...
export interface ApiMemberMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    displayRole: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiStatuteStatute extends Struct.SingleTypeSchema {
  collectionName: 'statutes';
  info: {
    description: '';
    displayName: 'Statutes';
    pluralName: 'statutes';
    singularName: 'statute';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::statute.statute': ApiStatuteStatute;
